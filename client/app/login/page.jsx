...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <container className="w-[400px] h-fit  bg-white shadow-2xl rounded-lg ">
        ...
        <div className="flex justify-center flex-col items-end mx-12 mt-5  ">
          ...
          <button onClick={validate} className="w-full rounded-lg border-[1px] z-[2] bg-white p-2 mb-4 text-black hover:bg-orange-200 active:bg-orange-400 hover:text-white text-extrabold mt-5 text-lg border-black">اهلا بك</button>
        </div>
